...
export const User = () => {
		...
		return <tbody>{
			...
			developerdata.map((row) => {
				const addtask=(e)=>{
					...
					axios.post(`http://localhost:4000/usertask`,data).then(res=>{
						console.log(res.data.data);
					})
				...
				if (row.role._id==="624c7737efbeec19caf8e4ff") {
					...
					return (
						...
						<tr>
							<td><button >{row.firstname}</button></td>
							<td><button >{row.email}</button></td>
  ...
  <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/>
					...
					<main class="content">
						...
						<h1 class="h3 mb-3"><strong>Developer-List</strong></h1> <br></br>
