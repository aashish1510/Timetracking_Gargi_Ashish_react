			  ...
			  const button=(e)=>{
				...
				return (
					  ...
					  <tr>
						  ...
						  <td><button onClick={button}>{row.estimatedhours}</button></td>
						  <td><button onClick={button}>{row.technology}</button></td>
						  <td>
							  <p><button type="button" class="btn btn-warning" onClick={() => { deleteData(row._id) }}>DELETE</button>  <button type="button" class="btn btn-info"   >UPDATE</button> </p>
