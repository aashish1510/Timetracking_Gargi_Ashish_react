...
import time from '../../src/image/times.jpg'
...
export const Dashboard = () => {
    ...
    var welcome = localStorage.getItem("firstname")

    const project = async(e)=>{
        e.preventDefault()
        if(localStorage.getItem("id")=="624c6d75efbeec19caf8693d")
        {
            navigate('/Projects')
        }
        else{
            alert("Oops!!You are not Project Manager")
        }
    }
        ...
        <div>
            <div className="wrapper">
                ...
                <div class="main">
                    ...
                    <main class="content">
                        <img src={time} class="image" />
                        <div class="top-left">
                        <button type="button" class="left" onClick={project}>Go to Project</button>
                        </div>
                        <div class="top-right">
                            <p>
                                A time tracking app is an essential time management <br></br>
                                tool that can help you and your team become more organized, <br></br>
                                efficient, and get more things done.Simply put, a time tracking <br></br>
                                app will save you and your company precious time - and money.<br></br>
